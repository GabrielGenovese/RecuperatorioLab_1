 ...
 * return retorna 0 si funciono sin problemas.
 * */
int validacionNumeroEnteroConMinMax(int* entero, int minimo, int maximo, char mensaje[],char *ERROR);


/*brief valida numeros flotantes entre el minimo y el maximo, si se ingresa otra cosa pide que vuelvas
 * a ingresar.
 * param1 el numero a validar, y al que se le asignara lo ingresado al final.
 * param2 es el minimo numero que puede ingresar.
 * param3 es el maximo numero que puede ingresar.
 * return retorna 0 si funciono sin problemas.
 * */
int validacionNumeroFloatConMinMax(float* entero, int minimo, int maximo, char mensaje[],char *ERROR);
